...
argParser.add_argument("-uAp", "--uArchPower", help="average power dissipation in W")
argParser.add_argument("-uAct", "--uArchCycletime", help="cycle duration in ns")
...
with pluginIni.open('w') as f:
    ...
    if not args.no_performance:
        ...
        if args.uArchPower is not None:
            f.write("plugin.perfEst.uArchPower="+str(args.uArchPower)+"\n")
        if args.uArchCycletime is not None:
            f.write("plugin.perfEst.uArchCycletime="+str(args.uArchCycletime)+"\n")
